      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <div className="mb-6 animate-fade-in">
            ...
            <h2 className="text-2xl md:text-4xl font-semibold text-white/90 drop-shadow-lg">
          ...
          {/* Enhanced subtitle */}
          <p className="text-xl md:text-2xl text-white/80 mb-8 max-w-3xl mx-auto leading-relaxed drop-shadow-lg animate-fade-in delay-300">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 animate-fade-in delay-500">
            ...
            <Button
              variant="outline"
              className="border-2 border-white text-white hover:bg-white hover:text-gpnet-blue px-10 py-5 rounded-xl transition-all duration-300 text-lg font-semibold backdrop-blur-sm bg-white/10 hover:shadow-xl"
            >
              Fale conosco agora
            </Button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
            <div className="group flex flex-col items-center p-8 bg-white/90 backdrop-blur-lg rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105 border border-white/20 animate-fade-in delay-700">
            ...
            <div className="group flex flex-col items-center p-8 bg-white/90 backdrop-blur-lg rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105 border border-white/20 animate-fade-in delay-1000">
              <div className="w-20 h-20 bg-gradient-to-r from-gpnet-green to-gpnet-blue rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="group flex flex-col items-center p-8 bg-white/90 backdrop-blur-lg rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105 border border-white/20 animate-fade-in delay-[1300ms]">
              <div className="w-20 h-20 bg-gradient-to-r from-gpnet-green to-gpnet-blue rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
          ...
          {/* Trust indicators */}
          <div className="mt-16 flex flex-wrap justify-center items-center gap-8 text-white/80 animate-fade-in delay-[1600ms]">
