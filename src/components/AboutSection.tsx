...
const AboutSection = () => {
  ...
  return <section id="sobre" className="py-20 bg-gradient-to-br from-gray-50 to-white">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <Card className="bg-white/80 backdrop-blur-sm shadow-xl border-0">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">Conectar pessoas e negócios com excelência, tecnologia e cuidado de verdade, tornando a internet um aliado simples, estável e presente no dia a dia.</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {pillars.map((pillar, index) => <Card key={index} className="bg-white hover:shadow-xl transition-all duration-300 transform hover:scale-105 border-0 shadow-lg animate-scale-in" style={{
